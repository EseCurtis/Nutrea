...
const BUNDLE_ID = 'com.topic.nikenft'; // ios bundle id
const PACKAGE = 'com.topic.nikenft'; // android package name
const NAME = 'Athlerse'; // app name
const EXPO_ACCOUNT_OWNER = 'ijele'; // expo account owner
const EAS_PROJECT_ID = 'd74673d6-d4e7-4785-b772-984c693a1a38'; // eas project id
const SCHEME = 'athlerse-app'; // app scheme
