...
export function ParticipantsButton() {
  return (
    <Pressable
      onPress={() => router.push('/hub/run-details/participants')}
      className="h-[66px] flex-row items-center justify-between px-6"
    >
      <Text className="text-[18px] font-medium">Participants</Text>
